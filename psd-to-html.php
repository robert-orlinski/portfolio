...
<head>
	...
	<title>Kodowanie według plików PSD | Robert Orliński</title>
...
<body>
	...
	<header>
		...
		<section class="banner banner--doing banner--psd" id="start">
			<div class="banner__header">
				<h1 class="banner__header__title">
                    <span class="banner__header__title--first-line banner__header__title--first-line--psd start-overlay-animation" data-overlay-animation="0" data-overlay-right="0">Kodowanie według plików PSD</span>
                </h1>
        ...
        <section class="features features--psd" id="cechy">
            <h2 class="features__header standard-header fade-animation">Czym kieruję się podczas tego procesu?</h2>
            <div class="features__content">
                ...
                <div class="features__content__text">
                    ...
                    <p class="fade-animation">Wszystkie otrzymane pliki dokładnie analizuję i z dbałością przekładam na działający produkt. Dzięki temu masz pewność, że efekt końcowy nie będzie różnił się od Twojej wizji strony internetowej.</p>
                </div>
            </div>          
            <div class="features__content">
                <div class="features__content__image overlay-animation" data-overlay-animation="0" data-overlay-right="0">
            ...
            <div class="features__content">
                ...
                <div class="features__content__text">
                    ...
                    <p class="fade-animation">Wszystkie witryny testuję na wszystkich najpopularniejszych przeglądarkach, takich jak Google Chrome, Firefox, Opera, Safari, Edge oraz Internet Explorer 11. Dzięki temu nie musisz się martwić, że użytkownik przeglądający stronę nie będzie mógł w pełni z niej skorzystać.</p>
                </div>
            </div>
            <div class="features__content">
                <div class="features__content__image overlay-animation" data-overlay-animation="0" data-overlay-right="0">
