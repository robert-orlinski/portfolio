...
<head>
	...
	<title>AquaStalka | Robert Orliński</title>
    ...
    <link rel="stylesheet" href="assets/css/aq.css">
		...
		<section class="banner banner--restaurant" id="start">
			<div class="banner__header">
				<h1 class="banner__header__title">
                    <span class="banner__header__title--first-line banner__header__title--aq start-overlay-animation" data-overlay-animation="0" data-overlay-right="0">AquaStalka</span>
                </h1>
            ...
            <img alt="" class="banner__mockup" src="assets/img/mockup-aq.png">
		</section>
	</header>
    <main id="tresc">
        <section class="about about--portfolio">
            <div class="about__content">
                <div>
                    <p class="about__content__text__paragraph fade-animation">AquaStalka jest przede wszystkim firmą tworzącą unikalne oraz minimalistyczne produkty dla akwarystów, a jednocześnie mającą pewny związek z informatyką. Moim zadaniem okazało się stworzenie witryny odpowiednio prezentującej całą markę i łączącej te dwie skrajne dziedziny.</p>
                    <div class="about__content__text__button">
                        <a class="about__content__text__button__link standard-button fade-animation link-animation" tabindex="-1" href="http://aquastalka.pl/aq">Zobacz stronę</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="info">
            <div class="info__content">
                <div class="info__content__website overlay-animation" data-overlay-animation="0" data-overlay-right="0">
                    <img alt="Widok całej strony internetowej" src="assets/img/aq-website.jpg" class="info__content__website__image">
                </div>
                <div class="info__content__text">
                    <div>
                        <h2 class="standard-header fade-animation">Zakres prac</h2>
                        <p class="fade-animation">Po konsultacjach z CEO firmy przystąpiłem do tworzenia witryny od podstaw. Wszystko rozpoczęło się od wstępnego szkicu, który później przerodził się w projekt graficzny, konsultowany ze zleceniodawcą. Na jego podstawie powstała już gotowa strona internetowa.</p>
                        <h2 class="standard-header fade-animation">Użyte technologie</h2>
                        <p class="fade-animation">Jak zwykle podstawą tej strony internetowej okazały się technologie takie jak HTML oraz CSS. Dodatkowy JavaScript wsparty o bibliotekę jQuery sprawił, że cała witryna stała się bardziej interaktywna, a cały proces usprawnił najpopularniejszy framework CSS, czyli Bootstrap.</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="mobile">
            <div class="mobile__content">
                <img alt="" class="mobile__content__mockup fade-animation" src="assets/img/mobile-mockup7.jpg">
                <img alt="" class="mobile__content__mockup fade-animation--second" src="assets/img/mobile-mockup8.jpg">
                <img alt="" class="mobile__content__mockup fade-animation--third" src="assets/img/mobile-mockup9.jpg">
            </div>
        </section>
