...
<head>
	...
	<title>Motyw WordPress | Robert Orliński</title>
		...
		<section class="banner banner--restaurant" id="start">
			<div class="banner__header">
				<h1 class="banner__header__title">
                    <span class="banner__header__title--first-line banner__header__title--theme start-overlay-animation" data-overlay-animation="0" data-overlay-right="0">Motyw WordPress</span>
                </h1>
            ...
            <img alt="" class="banner__mockup" src="assets/img/mockup-theme.png">
		</section>
	</header>
    <main id="tresc">
        <section class="about about--portfolio">
            <div class="about__content">
                <div>
                    <p class="about__content__text__paragraph fade-animation">Poza tworzeniem witryn internetowych uwielbiam dzielić się wiedzą. Dlatego powstał blog, dla którego stworzyłem dedykowaną szatę graficzną wzbogaconą o tylko te funkcje, które są potrzebne, dlatego całość działa znacznie szybciej od standardowego motywu i daje mi pełną kontrolę.</p>
                    <div class="about__content__text__button">
                        <a class="about__content__text__button__link standard-button fade-animation link-animation" tabindex="-1" href="http://blog.robertorlinski.pl">Zobacz stronę</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="info">
            <div class="info__content">
                <div class="info__content__website overlay-animation" data-overlay-animation="0" data-overlay-right="0">
                    <img alt="Widok całej strony internetowej" src="assets/img/theme-website.png" class="info__content__website__image">
                </div>
                <div class="info__content__text">
                    <div>
                        <h2 class="standard-header fade-animation">Zakres prac</h2>
                        <p class="fade-animation">Na początku zebrane myśli przelałem na kartkę w postaci szkicu podstron zawartych w motywie, po czym od razu przystąpiłem do kodowania. Oczywiście podczas prac nie mogło obyć się bez poprawek lub nawet diametralnych zmian już po zakodowaniu całej witryny.</p>
                        <h2 class="standard-header fade-animation">Użyte technologie</h2>
                        <p class="fade-animation">Jak zawsze podstawę stanowi HTML oraz CSS usprawniony o preprocesor Less. JavaScript sprawia, że motywie lepiej reaguje na poczynania użytkownika, a za działanie po stronie serwera odpowiada PHP. Ten ostatni komunikuje się z WordPressem, o którego cała witryna została oparta.</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="mobile">
            <div class="mobile__content">
                <img alt="" class="mobile__content__mockup fade-animation" src="assets/img/mobile-mockup10.png">
                <img alt="" class="mobile__content__mockup fade-animation--second" src="assets/img/mobile-mockup11.png">
                <img alt="" class="mobile__content__mockup fade-animation--third" src="assets/img/mobile-mockup12.png">
            </div>
        </section>
