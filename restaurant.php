...
<head>
	...
	<title>Restauracja | Robert Orliński</title>
		...
		<section class="banner banner--restaurant" id="start">
			<div class="banner__header">
				<h1 class="banner__header__title">
                    <span class="banner__header__title--first-line banner__header__title--restaurant start-overlay-animation" data-overlay-animation="0" data-overlay-right="0">Strona dla restauracji</span>
                </h1>
            ...
            <img alt="" class="banner__mockup" src="assets/img/mockup-res.png">
		</section>
	</header>
    <main id="tresc">
        <section class="about about--portfolio">
            <div class="about__content">
                <div>
                    <p class="about__content__text__paragraph fade-animation">Najlepszym sposobem na naukę tworzenia stron internetowych jest kodowanie własnych projektów, dlatego nie mogło zabraknąć tych niekomercyjnych. Z tego powodu stworzyłem tę oto realizację, która mogłaby stanowić dobrą wizytówkę dla działającej restauracji.</p>
                        <a class="about__content__text__button__link standard-button fade-animation link-animation" tabindex="-1" href="https://robertorlinski.pl/restauracja-witryna">Zobacz stronę</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="info">
            <div class="info__content">
                <div class="info__content__website overlay-animation" data-overlay-animation="0" data-overlay-right="0">
                    <img alt="Widok całej strony internetowej" src="assets/img/restaurant-website.jpg" class="info__content__website__image">
                </div>
                <div class="info__content__text">
                    <div>
                        <h2 class="standard-header fade-animation">Zakres prac</h2>
                        <p class="fade-animation">Do moich zadań należało stworzenie niestandardowej witryny typu “one page” wraz z systemem rezerwacji przez e-mail, galerią, dedykowanym preloaderem oraz dostosowaną mapą Google’a.</p>
                        <h2 class="standard-header fade-animation">Użyte technologie</h2>
                        <p class="fade-animation">Zawartość witryny została zakodowana w HTMLu i ostylowana za pomocą CSSa. Za integrację z użytkownikiem odpowiada JavaScript wspierany przez bibliotekę jQuery, a język PHP pozwala działać wszystkim formularzom widocznym na stronie internetowej.</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="mobile">
            <div class="mobile__content">
                <img alt="" class="mobile__content__mockup fade-animation" src="assets/img/mobile-mockup1.jpg">
                <img alt="" class="mobile__content__mockup fade-animation--second" src="assets/img/mobile-mockup2.jpg">
                <img alt="" class="mobile__content__mockup fade-animation--third" src="assets/img/mobile-mockup3.jpg">
            </div>
        </section>
